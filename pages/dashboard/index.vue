        ...
        <div class="
          ...
          <div class="flex items-end space-x-2 my-6 justify-between">
            ...
            <t-input v-else v-model="user.name" type="text"
              classes="text-2xl text-black dark:text-white font-bold text-right border-gray-300" />
          </div>
          <div class="dark:text-white">
            <div class="
              ...
              ">
              <p>Name</p>
              <div v-if="!editId || editId !== user.id" class="flex items-end">
                {{ user.name }}
              </div>
              <t-input v-else v-model="user.name" type="text" classes="flex items-end text-right border-gray-300" />
            </div>
            <div class="
                flex
                items-center
              ...
              <t-input v-else v-model="user.email" type="email" classes="flex items-end text-right border-gray-300" />
            </div>
            <div class="
                flex
                items-center
